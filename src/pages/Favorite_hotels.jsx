    ...
    return (
        <Container className='py-5'>
            ...
            <div className='flex pt-5 flex-col items-start gap-4'>
                <h1 className='text-lg font-bold text-black' style={{
                    fontFamily: "'Roboto', sans-serif"
                }}>Added today</h1>

                <div className='grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 items-start gap-2 w-full'>
                    {favoriteHotelsData.map((ElemItem) => {
                        return (
                            <div className='flex overflow-auto no_scrollBar items-start flex-col gap-2 h-88 rounded-lg w-full bg-white border border-gray-100 shadow-lg'>
                                <div className='relative w-full h-40'>
                                    <img src={ElemItem.image} className='w-full rounded-t-lg h-full line-clamp-1' alt={ElemItem.name} />
                                    <span className='absolute top-2 right-2 w-8 text-md h-8 rounded-full p-1 bg-gray-100 text-orange-600 flex items-center justify-center'><FaHeart /></span>
                                </div>
                                <div className='flex flex-col gap-2 items-start pb-2 w-full'>
                                    <div className='flex flex-col items-start w-full px-2'>
                                        ...
                                        <div className='flex mt-1 items-center gap-1'>
                                            <i className='text-sm text-yellow-600'><IoStar /></i>
                                            <i className='text-sm text-yellow-600'><IoStar /></i>
                                            <i className='text-sm text-yellow-600'><IoStar /></i>
                                            <i className='text-sm text-yellow-600'><IoStar /></i>
                                        </div>
                                    ...
                                    <div className='flex flex-col items-start w-full px-2'>
                                        ...
                                        <p className='text-sm line-clamp-2 w-60 text-gray-500'>{ElemItem.reviews} reviews </p>

                                    </div>


                                    <div className='flex flex-col border-t border-gray-100 px-2 py-2 items-start w-full'>
                                        <h1
                                            style={{
                                                fontFamily: "'Roboto', sans-serif"
                                            }}
